module tht_led_3mm () {
  tht_led(3, 4, 5, raster = 2.54);
}

module tht_led_5mm () {
  tht_led(5, 6, 8.6, raster = 2.54);
}

module tht_led_10mm () {
  tht_led(10, 11, 13.5, raster = 2.54);
}

module tht_led (d, protrusion_d, head_h, raster = 0, protrusion_h = 1, anode_l = 25.4, cathode_l = 24.4, terminal_d = 0.6) {
